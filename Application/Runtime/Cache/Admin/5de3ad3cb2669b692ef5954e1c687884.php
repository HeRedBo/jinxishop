...
<div class="main-div">
    <form name="main_form" method="POST" action="/Admin/Attribute/edit/id/7.html" enctype="multipart/form-data">
        ...
        <table cellspacing="1" cellpadding="3" width="100%">
            ...
            <tr>
                ...
                <td>
                    <textarea name="attr_option_values" id="" cols="60" rows="3" <?php if($data['attr_input_type'] ==0) echo 'disabled ="disabled"'?>><?php if(!empty($data['attr_value']) && $data['attr_input_type'] ==1) echo $data['attr_value'] ?></textarea>
                </td>
            </tr>
            <tr>
