...
//下面这段代码是放置 session过期了 在主框架显示登录界面的js代码
...
<form method="post" action="" name='theForm' id="login_form">
  ...
  <tr>
    ...
    <td style="padding-left: 50px">
      ...
      <td colspan="2" align="right">
       <img src="<?php echo U('checkcode'); ?>" alt="CAPTCHA" style="cursor: pointer;" title="看不清？点击更换另一个验证码。" onclick="this.src='<?php echo U('checkcode'); ?>#'+Math.random()" />
       <a href="javascript:;" onclick="$(this).prev('img').trigger('click');" style="color:#fff;">看不清?换一张</a>
      </td>
      </tr>
