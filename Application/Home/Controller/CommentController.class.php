...
class CommentController extends BaseController
{
	...
	public function ajaxGetComment()
	{
		...
		$comment = M('Comment');
		$data    = $comment
					->field('a.*,B.email,B.face,COUNT(C.id) reply_count')
					->alias('a')
					->join('LEFT JOIN shop_member B ON a.member_id = B.id LEFT JOIN shop_reply C ON a.id = C.comment_id ')
